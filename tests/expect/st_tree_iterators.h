...
// Generated to_string for PUBLIC STRUCT_DECL st_tree::detail::b1st_iterator
  public:
  auto to_string() const {
    return fstr::format(R"( st_tree::detail::b1st_iterator: int _queue={}
)", _queue);
  }
};
...
struct d1st_post_iterator {
    ...
    struct frame {
        ...
        iterator second;
        bool visited;
    // Generated to_string for PUBLIC STRUCT_DECL st_tree::detail::d1st_post_iterator<Node, Value, Alloc>::frame
  public:
  auto to_string() const {
    return fstr::format(R"( st_tree::detail::d1st_post_iterator<Node, Value, Alloc>::frame: node_type * first={}, iterator second={}, bool visited={}
)", fmt::ptr(first), second, visited);
  }
};
...
// Generated to_string for PUBLIC STRUCT_DECL st_tree::detail::d1st_post_iterator
  public:
  auto to_string() const {
    return fstr::format(R"( st_tree::detail::d1st_post_iterator: int _stack={}
)", _stack);
  }
};
...
struct d1st_pre_iterator {
    ...
    struct frame {
        ...
        iterator second;
        bool visited;
    // Generated to_string for PUBLIC STRUCT_DECL st_tree::detail::d1st_pre_iterator<Node, Value, Alloc>::frame
  public:
  auto to_string() const {
    return fstr::format(R"( st_tree::detail::d1st_pre_iterator<Node, Value, Alloc>::frame: node_type * first={}, iterator second={}, bool visited={}
)", fmt::ptr(first), second, visited);
  }
};
    ...
    typedef typename std::allocator<frame> frame_allocator_type;
    vector<frame, frame_allocator_type> _stack;
// Generated to_string for PUBLIC STRUCT_DECL st_tree::detail::d1st_pre_iterator
  public:
  auto to_string() const {
    return fstr::format(R"( st_tree::detail::d1st_pre_iterator: int _stack={}
)", _stack);
  }
};

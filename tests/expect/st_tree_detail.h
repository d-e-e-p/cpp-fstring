...
struct max_maintainer {
    ...
    Unsigned _max;
// Generated to_string for PUBLIC STRUCT_DECL st_tree::detail::max_maintainer
  public:
  auto to_string() const {
    return fstr::format(R"( st_tree::detail::max_maintainer: int _hist={}, Unsigned _max={}
)", _hist, _max);
  }
};
...
// Generated to_string for PUBLIC STRUCT_DECL st_tree::detail::valmap_iterator_adaptor_forward
  public:
  auto to_string() const {
    return fstr::format(R"( st_tree::detail::valmap_iterator_adaptor_forward: base_iterator_type _base={}, valmap _vmap={}
)", _base, _vmap);
  }
};
...
// Generated to_string for PUBLIC STRUCT_DECL st_tree::detail::valmap_iterator_adaptor_random
  public:
  auto to_string() const {
    return fstr::format(R"( st_tree::detail::valmap_iterator_adaptor_random: base_iterator_type _base={}, valmap_type _vmap={}
)", _base, _vmap);
  }
};
...
struct ptr_less {
    ...
    Compare _comp;
// Generated to_string for PUBLIC CLASS_TEMPLATE st_tree::detail::ptr_less<Compare>
  public:
  auto to_string() const {
    return fstr::format(R"( st_tree::detail::ptr_less<Compare>: <{}> _comp={}
)", typeid(Compare).name(), _comp);
  }
};
...
struct ptr_less_data {
    ...
    Compare _comp;
// Generated to_string for PUBLIC CLASS_TEMPLATE st_tree::detail::ptr_less_data<Compare>
  public:
  auto to_string() const {
    return fstr::format(R"( st_tree::detail::ptr_less_data<Compare>: <{}> _comp={}
)", typeid(Compare).name(), _comp);
  }
};

...
namespace tinyply
{
  ...
  auto to_string() const {
    return fstr::format(R"( tinyply::PropertyInfo: int stride={}, str={}
)", stride, str);
  }
};
  ...
  public:
  auto to_string() const {
    return fstr::format(R"( tinyply::Buffer: int * alias={}, int data={}, size={}
  ...
  public:
  auto to_string() const {
    return fstr::format(R"( tinyply::PlyData: Type t={}, Buffer buffer={}, int count={}, bool isList={}
  ...
  public:
  auto to_string() const {
    return fstr::format(R"( tinyply::PlyProperty: int name={}, Type propertyType={}, bool isList={}, Type listType={}, int listCount={}
  ...
  public:
  auto to_string() const {
    return fstr::format(R"( tinyply::PlyElement: int name={}, size={}, properties={}
  ...
  public:
  auto to_string() const {
    return fstr::format(R"( tinyply::PlyFile: int impl={}
)", impl);
  }
};
...
// Generated formatter for PUBLIC enum tinyply::Type of type INT scoped
constexpr auto format_as(const tinyply::Type obj) {
  fmt::string_view name = "<missing>";
  switch (obj) {
    case tinyply::Type::INVALID: name = "INVALID"; break;  // index=0
    case tinyply::Type::INT8   : name = "INT8"   ; break;  // index=1
    case tinyply::Type::UINT8  : name = "UINT8"  ; break;  // index=2
    case tinyply::Type::INT16  : name = "INT16"  ; break;  // index=3
    case tinyply::Type::UINT16 : name = "UINT16" ; break;  // index=4
    case tinyply::Type::INT32  : name = "INT32"  ; break;  // index=5
    case tinyply::Type::UINT32 : name = "UINT32" ; break;  // index=6
    case tinyply::Type::FLOAT32: name = "FLOAT32"; break;  // index=7
    case tinyply::Type::FLOAT64: name = "FLOAT64"; break;  // index=8
  }
  return name;
}

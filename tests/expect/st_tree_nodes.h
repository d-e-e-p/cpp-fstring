...
// Generated to_string for PUBLIC STRUCT_DECL st_tree::detail::node_base
  public:
  auto to_string() const {
    return fstr::format(R"( st_tree::detail::node_base: tree_type * _tree={}, size_type _size={}, node_type * _parent={}, data_type _data={}, cs_type _children={}, max_maintainer<size_type, allocator_type> _depth={}
)", fmt::ptr(_tree), _size, fmt::ptr(_parent), _data, _children, _depth);
  }
};
...
// Generated to_string for PUBLIC STRUCT_DECL st_tree::detail::node_keyed
  public:
  auto to_string() const {
    return fstr::format(R"( st_tree::detail::node_keyed: key_type _key={}
)", _key);
  }
};

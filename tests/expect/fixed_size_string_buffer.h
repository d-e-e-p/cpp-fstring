...
class FixedSizeStringBuffer {
 ...
 private:
  ...
  auto to_string() const {
    return fstr::format(R"( fssb::FixedSizeStringBuffer<SPACE>::Pointer: int front={}, len={}
)", front, len);
  }
};
 ...
 private:
  ...
  public:
  auto to_string() const {
    return fstr::format(R"( fssb::FixedSizeStringBuffer<SPACE>::SlotState: int bopen={}, bword={}, bclos={}
)", bopen, bword, bclos);
  }
} ;
...
// Generated to_string for PUBLIC CLASS_TEMPLATE fssb::FixedSizeStringBuffer<SPACE>
  public:
  auto to_string() const {
    return fstr::format(R"( fssb::FixedSizeStringBuffer<SPACE>: int chars_={}, ptr_={}, back_={}, max_chars_={}, free_chars_={}, bool debug_={}
)", chars_, ptr_, back_, max_chars_, free_chars_, debug_);
  }
};  // end class
